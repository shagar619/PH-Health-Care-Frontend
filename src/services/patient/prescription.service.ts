...
export async function getMyPrescriptions(queryString?: string) {
     ...
     try {
          ...
          const response = await serverFetch.get(`/prescription/my-prescription${queryString ? `?${queryString}` : ""}`,
          {
          next: {
...
export async function getAllPrescriptions(queryString?: string) {
     ...
     try {
          ...
          const response = await serverFetch.get(`/prescription${queryString ? `?${queryString}` : ""}`,
          {
               next: {
