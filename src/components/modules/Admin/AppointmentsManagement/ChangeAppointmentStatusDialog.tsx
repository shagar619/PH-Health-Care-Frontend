...
import { changeAppointmentStatus } from "@/services/admin/appointmentsManagement";
...
const ChangeAppointmentStatusDialog = ({
     ...
     const [selectedStatus, setSelectedStatus] = useState<AppointmentStatus>(appointment?.status || AppointmentStatus.SCHEDULED);
